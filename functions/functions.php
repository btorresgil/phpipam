...
/* set latest version */
define("VERSION", "0.96");									//version changes if database structure changes
/* set latest revision */
define("REVISION", "009");									//revision always changes, verision only if database structure changes
