...
/* set latest version */
define("VERSION", "0.98");									//version changes if database structure changes
/* set latest revision */
define("REVISION", "008");									//revision always changes, verision only if database structure changes
