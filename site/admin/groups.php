...
if(sizeof($groups)>0) {
	foreach ($groups as $g)
	{
		...
		print "		<button class='btn btn-sm btn-default addToGroup' 		data-groupid='$g[g_id]' data-action='add'    rel='tooltip' data-container='body'  title='"._('add users to this group')."'>   	<i class='fa fa-plus'></i></button>";
		print "		<button class='btn btn-sm btn-default removeFromGroup' 	data-groupid='$g[g_id]' data-action='remove' rel='tooltip' data-container='body'  title='"._('remove users from this group')."'><i class='fa fa-minus'></i></button>";
		print "	</div>";
		print "</td>";
		...
		print "<td class='actions'>";	
		print "	<div class='btn-group'>";
		print "		<button class='btn btn-sm btn-default editGroup'  		data-groupid='$g[g_id]' data-action='edit'   rel='tooltip' data-container='body'  title='"._('edit group details')."'>	<i class='fa fa-pencil'></i></button>";
		print "		<button class='btn btn-sm btn-default editGroup'  		data-groupid='$g[g_id]' data-action='delete' rel='tooltip' data-container='body'  title='"._('remove group')."'>		<i class='fa fa-times'></i></button>";
		print "	</div>";
		print "</td>";
