...
<div class="pFooter">
	<div class="btn-group">
		...
		<button class="btn btn-small <?php if($_POST['action']=="delete") { print "btn-danger"; } else { print "btn-success";} ?>" id="editcustomUserSubmit"><i class="icon-white <?php if($_POST['action']=="add") { print "icon-plus"; } else if ($_POST['action']=="delete") { print "icon-trash"; } else { print "icon-ok"; } ?> icon-ok"></i> <?php print ucwords(_($_POST['action'])); ?></button>
	</div>
	<!-- result -->
